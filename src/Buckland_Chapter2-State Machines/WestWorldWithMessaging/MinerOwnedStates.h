...
//  his thirst is quenched. Quand il est satisfait, il va interragir avec 
//	le saoulard.
//
//------------------------------------------------------------------------
...
//------------------------------------------------------------------------
//
//  Les discussions avec le saoulard quand il est instable ou calme, jusqu'à la fin des 
//	message. Quand il n'a plus de message à dire/reçevoir au saoulard, il va à la mine.
//
//------------------------------------------------------------------------
class TalkWithDrunken : public State<Miner>
{
private:

	TalkWithDrunken() {}

	TalkWithDrunken(const TalkWithDrunken&);
	TalkWithDrunken& operator=(const TalkWithDrunken&);
